...
<div class="container">
    ...
    <h1 class="p-3 fs-2 border-top border-3">Tu receta en tu despensa <span class="text-success">RadCook<span></h1>
     <p class="p-3  fs-4">
         <span class="text-success">RadCook</span> Te ayuda a encontrar esa receta para cada ocasión, ingresa tus propios ingredientes o encuentra gran variedad creadas por nuestros propios usuarios... !COMPARTE TU RECETA Y SE PARTE DE ESTA GRAN COMUNIDAD!
     </p>
    </section>
    <div>
    ...
    <div class="container w-50 m-auto text-center" id="equipo">
        <h1 class="mb-5 fs-2">Una receta no tiena alma. <span class="text-success">Es el cocinero quien debe darle alma a la receta</span>.</h1>
        <p class="fs-4 ">Somos un equipo pequeño compremetidos con el desarrollo de esta plataforma web... descarga nuestra app en tu movil donde podras guardar y descargar tus recetas. </p>
    </div>
